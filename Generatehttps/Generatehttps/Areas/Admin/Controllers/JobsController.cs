...
namespace Generatehttps.Areas.Admin.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Salary,Description,Status,Image,StatusEnable,JobDate,Experience,Others,CategoryId,WorkingTime,WorkingForm")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Salary,Description,Status,Image,StatusEnable,JobDate,Experience,Others,CategoryId,WorkingTime,WorkingForm")] Job job)
        {
            if (id != job.Id)
            {
                return NotFound();
